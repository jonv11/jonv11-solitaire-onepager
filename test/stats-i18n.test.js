...
test('Stats panel re-renders on language change', () => {
  const dom = new JSDOM('<!DOCTYPE html><body><nav class="toolbar"></nav></body>');
  globalThis.window = dom.window;
  globalThis.document = dom.window.document;

  globalThis.Popup = {
    trapFocus() {},
    open(o) { o.classList.add('show'); },
    close(o) { o.classList.remove('show'); },
  };
