...
// Load engine and solver into a shared context
...
function trivialWin() {
  ...
  st.piles.tableau = suits.map((s, i) => ({
    id: "tab-" + (i + 1),
    kind: "tableau",
    col: i + 1,
    cards: [card(s, 13)],
...
function kingBlock() {
  ...
  st.piles.tableau = [
    {
      ...
      kind: "tableau",
      col: 1,
      cards: [card("S", 5, false), card("H", 13)],
    },
  ...
  st.piles.foundations = ["S", "H", "D", "C"].map((s) => ({
    id: "foundation-" + s,
    kind: "foundation",
    suit: s,
    cards: [],
